...
# with command line options: NANO --python_filename topNano_v6-1-1_2018D_data_cfg.py --fileout file:tree.root -s NANO --data --conditions 102X_dataRun2_Prompt_v15 --era Run2_2018,run2_nanoAOD_102Xv1 --eventcontent NANOAOD --datatier NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100 --nThreads 2 -n -1 --no_exec
