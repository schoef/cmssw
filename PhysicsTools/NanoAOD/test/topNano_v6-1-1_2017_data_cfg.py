...
# with command line options: NANO --python_filename topNano_v6-1-1_2017_data_cfg.py --fileout file:tree.root -s NANO --data --conditions 102X_dataRun2_v12 --era Run2_2017,run2_nanoAOD_94XMiniAODv2 --eventcontent NANOAOD --datatier NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100 --nThreads 2 -n -1 --no_exec
